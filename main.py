                    ...
                    if x != None and y != None:
                        if tool.__str__() == 'P' and (y == 7 or y==0):
                            ...
                            if legal == True:
                                ...
                                tool=Queen(pygame.image.load('gui/pieces_images/'+promotion_color + 'queen.png'),tool.pos,tool.color)
                            ...
                            if x>7-prev_pos_logic[0] and legal:
                                ...
                                draw([start_pos[0] + (7 * square_size), start_pos[1] + (7 * square_size)], square_castle_color, square_castle_color, 7, 5)
                                board[7][5]=(Rook(pygame.image.load('gui/pieces_images/'+ rook_castle_color + 'rook.png'),[tool.pos[0]+square_size,tool.pos[1]],tool.color))
